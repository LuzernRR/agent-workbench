...
export function WorkbenchShell({ projectId, threadId, onSelectThread }: { projectId: string | null | undefined; threadId: string | null; onSelectThread?: (projectId: string | null, threadId: string | null) => void }) {
